...
public class MaterialIntroView extends RelativeLayout {
    ...
    /**
     * Button View will be shown if
     * this is true
     */
    private boolean isSkipViewEnabled;
    ...
    private void init(Context context) {
        ...
        skipButton = layoutInfo.findViewById(R.id.skip_button);
    ...
    private void setInfoLayout() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (!isSkipViewEnabled){
                    skipButton.setVisibility(GONE);
                }

                if(skipButtonText != null && !skipButtonText.trim().isEmpty()){
                ...
                skipButton.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(materialIntroListener != null)
                            materialIntroListener.onSkipClicked();
                    }
                });
    ...
    private void enableSkipViewButton(boolean isSkipViewEnabled){
        this.isSkipViewEnabled = isSkipViewEnabled;
    }

    private void textSkipButton(String skipButtonText){
    ...
    public static class Builder {
        ...
        public Builder enableSkipButton(boolean isSkipViewEnabled) {
            materialIntroView.enableSkipViewButton(isSkipViewEnabled);
            return this;
        }

        public Builder textSkipButton(String skipButtonText) {
            materialIntroView.textSkipButton(skipButtonText);
            return this;
        }
